...
const backgroundGray = "#e7e8e9";
const supportGray = "#6c6e6e";
const supportGreen = "#306f83";
const popOrange = "#db7b35";
const popGreen = "#1eb7aa";
...
export default class extends React.Component {
  ...
  randomAnimData = () => {
    ...
    const frontierTypes = points.map(() => {
      const t = Math.random();
